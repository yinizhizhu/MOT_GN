...
# test_lengths = [1500]
#
# test_seqs = [1, 6, 7, 8, 12, 14]
# test_lengths = [450, 1194, 500, 625, 900, 750]
...
class GN():
    def __init__(self, seq_index, tt, a, cuda=True):
        ...
        self.out_dir = t_dir + 'motmetrics_%s_7_cf_%.1f_iou_%.1f_vc_%.2f_%s_fgap_%d_new/'%(type,
                                                                                           cf,
                                                                                           iou,
                                                                                           vot_conf_score,
                                                                                           recover_dir,
            ...
            for t in types:
                ...
                for i in xrange(len(test_seqs)):
                    ...
                    if tt_tag:
                        ...
                        start = time.time()
                        print '     Evcaluating Graph Network...'
