import shutil, os
from global_set import edge_initial, f_gap
...
for type in types:
    for i in xrange(n):
        src_dir = 'Results/MOT%d/%s/%02d/%d/%s_%s_7%s/res_training.txt'%(year,
                                                                         ...
                                                                         name,
                                                                         type,
                                                                         '_cf_0.3_iou_0.5_vc_0.98__NoRecover_fgap_%d_new'%f_gap)
