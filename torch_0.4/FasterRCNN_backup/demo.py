...
vgg_resnet = 2  # 1 - vgg16, 2 - resnet101
...
if __name__ == '__main__':
    ...
    step = 1  # Iteration for cropping image
    args = parse_args()
    ...
    if args.net == 'vgg16':
        ...
        fasterRCNN = resnet(pascal_classes, 50, pretrained=True, class_agnostic=args.class_agnostic)
    elif args.net == 'res152':
        fasterRCNN = resnet(pascal_classes, 152, pretrained=True, class_agnostic=args.class_agnostic)
    else:
    ...
    while (num_images >= 0):
        ...
        print rois.size(), rois
        print cls_prob.size(), cls_prob
        print bbox_pred.size(), bbox_pred
        print rois_label
        ...
        # for j in xrange(1, len(pascal_classes)):
            ...
            if inds.numel() > 0:
                ...
                if vis:
                    ...
                    im2show = vis_detections(im2show, pascal_classes[j], dets, 0.5)
